class_name ContentVariantDefinition
extends Resource
...
@export var inherent_modifier_set: ModifierSet
@export var extra_modifier_sets: Array[ModifierSet] = []
...
func apply_to_wave(definition: WaveDefinition) -> void:
	...
	if inherent_modifier_set != null:
		definition.monster_modifier_sets.append(inherent_modifier_set)
	for modifier_set in extra_modifier_sets:
		if modifier_set != null:
			definition.monster_modifier_sets.append(modifier_set)

func get_grant_lines() -> Array[String]:
	return _get_modifier_lines(inherent_modifier_set)

func get_extra_lines() -> Array[String]:
	var lines: Array[String] = []
	for modifier_set in extra_modifier_sets:
		lines.append_array(_get_modifier_lines(modifier_set))
	return lines

func get_wave_change_lines() -> Array[String]:
	var lines: Array[String] = []
...
func _get_modifier_lines(modifier_set: ModifierSet) -> Array[String]:
	var lines: Array[String] = []
	if modifier_set == null:
		return lines
